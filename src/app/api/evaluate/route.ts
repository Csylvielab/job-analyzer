...
请在报告的最后，输出以下JSON格式的五维评分数据（0-100分），用于生成能力雷达图：
...
评分维度说明：
- **技能**：硬技能掌握程度，与JD要求的技术栈匹配度
- **经验**：工作年限、项目经验深度、相关领域经验
- **行业背景**：对目标公司所在行业的了解程度、行业资源
- **软实力**：沟通协作、领导力、学习能力、抗压能力
- **教育**：学历水平、专业相关度、持续学习经历

请根据简历真实情况客观评分，并在"shortest"字段指出得分最低的维度名称。
`;
}
